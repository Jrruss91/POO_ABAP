CLASS zcl_lab_17_super_discount_4919 DEFINITION INHERITING FROM zcl_lab_16_price_discount_4919
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_LAB_17_SUPER_DISCOUNT_4919 IMPLEMENTATION.
...
*    super->add_price( ).
    ...
    lv_calculo = ls_flight-price * '0.20'.
